...
namespace AppBooking.Controllers
{
    ...
    public class FlightController : ControllerBase
    {
        ...
        public async Task<ActionResult<Flight>> PostFlight(Flight flight)
        {
            ...
            {
                string seatNumber = string.Concat("B", flight.FlightDistance.DepartureCity.AsSpan(0, 2), flight.FlightDistance.DestinationCity.AsSpan(0, 2), i.ToString("D3")); 
                // Định dạng số thành chuỗi với ít nhất 3 chữ số
                var seat = new Seat
                {
            ...
            {
                string seatNumber = string.Concat("E", flight.FlightDistance.DepartureCity.AsSpan(0, 2), flight.FlightDistance.DestinationCity.AsSpan(0, 2), i.ToString("D3")); 
                // Định dạng số thành chuỗi với ít nhất 3 chữ số
                var seat = new Seat
                {
                    SeatNumber = seatNumber,
